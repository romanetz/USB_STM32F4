...
#define USBD_PRODUCT_HS_STRING        "Joystick/MSC HS mode"
...
#define USBD_CONFIGURATION_HS_STRING  "HID/MSC Config"
#define USBD_INTERFACE_HS_STRING      "HID/MSC Interface"

#define USBD_CONFIGURATION_FS_STRING  "HID/MSC Config"
#define USBD_INTERFACE_FS_STRING      "HID/MSC Interface"
/**
  * @}
  */ 
