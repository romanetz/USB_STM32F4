...
#define EVAL_AUDIO_IRQ_SUBRIO            2   /* Select the sub-priority level (0 is the highest) */
...
#define Audio_I2S_IRQHandler           SPI3_IRQHandler
 ...
 #define AUDIO_DAC_CHANNEL              DAC_Channel_2 //DAC Channel 1 is busy :-)
 ...
 #define AUDIO_DAC_DMA_STREAM           DMA1_Stream6
 #define AUDIO_DAC_DMA_DREG             DAC_DHR12L2_ADDRESS
 #define AUDIO_DAC_DMA_CHANNEL          DMA_Channel_7
 #define AUDIO_DAC_DMA_IRQ              DMA1_Stream6_IRQn
 #define AUDIO_DAC_DMA_FLAG_TC          DMA_FLAG_TCIF6
 #define AUDIO_DAC_DMA_FLAG_HT          DMA_FLAG_HTIF6
 #define AUDIO_DAC_DMA_FLAG_FE          DMA_FLAG_FEIF6
 #define AUDIO_DAC_DMA_FLAG_TE          DMA_FLAG_TEIF6
 #define AUDIO_DAC_DMA_FLAG_DME         DMA_FLAG_DMEIF6

 #define Audio_MAL_DAC_IRQHandler       DMA1_Stream6_IRQHandler
