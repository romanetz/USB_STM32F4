...
static uint8_t  *USBD_HID_MSC_GetCfgDesc (uint8_t speed, uint16_t *length);
...
USBD_Class_cb_TypeDef  USBD_HID_MSC_cb = 
{
  ...
  NULL, /*EP0_TxSent*/  
  NULL, /*EP0_RxReady*/
  USBD_HID_MSC_DataIn, /*DataIn*/
  USBD_HID_MSC_DataOut, /*DataOut*/
  NULL, /*SOF */
  NULL,
  NULL,      
  USBD_HID_MSC_GetCfgDesc,
#ifdef USB_OTG_HS_CORE  
  USBD_HID_MSC_GetCfgDesc, /* use same config as per FS */
#endif  
};
...
__ALIGN_BEGIN static uint8_t USBD_HID_MSC_CfgDesc[USB_HID_MSC_CONFIG_DESC_SIZ] __ALIGN_END =
{
...
/**
  * @brief  USBD_HID_MSC_SendHidReport 
  *         Send HID Report
  * @param  pdev: device instance
  * @param  buff: pointer to report
  * @retval status
  */
uint8_t USBD_HID_MSC_SendHidReport (USB_OTG_CORE_HANDLE  *pdev, 
                                    uint8_t *report,
                                    uint16_t len)
{
...
* @retval status
*/
uint8_t  USBD_HID_MSC_DataOut (void  *pdev, uint8_t epnum)
{
  if(epnum == MSC_OUT_EP)
  {
